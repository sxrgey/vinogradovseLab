...
import static tech.reliab.course.vinogradovse.bank.utils.Constants.*;
...
import tech.reliab.course.vinogradovse.bank.exception.CreditException;
...
import tech.reliab.course.vinogradovse.bank.utils.Constants;
...
public class Main {
  public static void main(String[] args) {
    ...
    try {
      // Создание банков
      bankService.create(new Bank("Vinogradov Bank"));
